...
However, the guests left without pictures, they left the keys inside the accommodation so that they couldn’t return. The partner was reluctant to cancel for no valid reason but asked if it was possible to remove the client's feedback if it was negative. Both partner and guest were angry and uncooperative.
...
### Outcome
Partner eventually agreed to cancel free of charge. As a result, both parties were relieved.
